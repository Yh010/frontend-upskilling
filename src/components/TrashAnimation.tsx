...
const TrashAnimation = () => {
 ...
 rounded-xl hover:text-[#f94144] font-semibold flex justify-center items-center duration-140 ease-out bg-[#f5f3f4] text-[#252422] shadow-xs border-[#d3d3d3]" onClick={AddToast}>
