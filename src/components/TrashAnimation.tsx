...
const TrashAnimation = () => {
      ...
      <div>
        ...
        <div className="flex-1 flex justify-center items-center">
          <div className="w-full flex justify-center grid grid-cols-2 gap-4 px-4">
            <Card idx={1} selectedItems={selectedItems} setSelectedItems={setSelectedItems} />
            <Card idx={2} selectedItems={selectedItems} setSelectedItems={setSelectedItems}/>
            <Card idx={3} selectedItems={selectedItems} setSelectedItems={setSelectedItems}/>
            <Card idx={4} selectedItems={selectedItems} setSelectedItems={setSelectedItems}/>
          </div>
      </div>
      
     
      <button className="px-4 py-2 self-center mb-4 border hover:bg-[#fae1dd] font-inter
 rounded-xl hover:text-[#f94144] font-semibold flex justify-center items-center duration-140 ease-out bg-[#f5f3f4] text-[#252422] shadow-xs border-[#d3d3d3]">
      ...
      <button className="px-4 py-2 self-center mb-4 border bg-[#ef233c] font-inter
